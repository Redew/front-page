...
const info = [
	{
		...
		title: "Dex",
		description: "A comprehensive list of Pokémon, items, abilities, and other data across every generation",
		buttonText: "View Dex",
	},

	{
		...
		title: "Flying Press",
		description: "Articles about competitive battling, tier lists, tournaments, and everything related to Pokémon",
...

	{
		...
		description: "Tutorials and tips for Pokémon games to conquer the battle tower, battle your friends, or find general information",
